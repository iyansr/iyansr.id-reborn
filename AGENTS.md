...
- `pnpm dev` serves on port `2718` (`pnpm start` previews the production build on port `22825`).
- Production Docker image serves prerendered static files from `.output/public` via nginx on port `22825`.
