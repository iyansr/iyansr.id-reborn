		...
		<>
			...
			<Section
				...
				<div className='container mx-auto flex h-full max-w-screen-lg flex-col items-center justify-center px-4 text-center md:px-8 lg:px-12'>
					...
					<p className='mt-4 text-sm font-medium text-gray-800 md:text-base lg:text-lg'>
						A Frontend Developer who passionate about modern mobile and web technology using React JS, React Native, and other React / JS Framework. And
						would be a fast learner to doing new things and build good teamwork either.
					</p>
				</div>
			</Section>
			...
			<Section
				...
				<div className='py-12 text-center'>
					...
					<p className='mt-4 text-sm font-medium text-gray-800 md:text-base lg:text-lg'>If I tell you what happen, it won't happen.</p>
				</div>
			...
			<Section
				...
				<div className='py-12 text-center'>
					...
					<p className='mt-4 text-sm font-medium text-gray-800 md:text-base lg:text-lg'>Projects, experiments and some stuff i've made.</p>
				</div>
				...
				<div className='flex w-full justify-center'>
					<Link href='/work'>
						<button className='article-button border-2 border-gray-900 bg-red-custom px-4 py-2 font-bold text-white focus:outline-none'>More Work</button>
					</Link>
				</div>
			</Section>
		</>
