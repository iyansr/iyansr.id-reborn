	...
	return (
		<article className='post-card overflow-hidden rounded-xl border-4 border-gray-800 bg-white'>
			...
			<div className='flex flex-1 flex-col p-4'>
				...
				<div className='card-content-body mt-2 flex-1 text-sm text-gray-700 line-clamp-3'>{excerpt}</div>

				<div className='flex  flex-wrap'>
					<div className='post-card--tag mr-2 mt-2 bg-red-custom px-2 py-1 text-xs font-medium text-gray-200'>#{post.tags}</div>
				</div>
			</div>
		</article>
	)
